...
// var blocksRoute = app.route('/blocks'); // using app.route is a recommended approach for avoiding duplicate route names. app.route returns route object which handles all requests to the /blocks path
// no path argument is neede for route handlers belonging t othe same route instance
// NEW 5. part2 CHAINING FUNCTIONS
app.route('/blocks') // chaining functions can eliminate intermediate variables and make it easier to read. Common pattern in Express aplications
...
// NEW part2
// NEW 5. part2 CHAINING FUNCTION calls means calling functions on the return value of previous functions
...
// lines starting with dot indicate function cals on the object returned from the previous line
