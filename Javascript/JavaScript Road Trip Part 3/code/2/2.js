...
function buildTicket(allRides, passRides, pick) {
    ...
    } //RETURNING A FUNCTION FROM A FUNCTION, complete wit hvariables from an external scrope, IS CALLED CLOSURE
} // The entire contents of the inner functions will still be available OUTSIDE the outermost function 
